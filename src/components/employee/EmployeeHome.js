                                ...
                                <div className="box-create-cv mb-16">
                                    <div className="box-item">
                                        ...
                                        <a
                                            ...
                                            className="btn btn-success btn-search-job"
                                        >
                                    ...
                                    <div className="box-image d-flex align-items-center justify-content-center">
                                        <img
                                            src="https://www.topcv.vn/v4/image/welcome/mau_cv.png?v=1.0.0"
                                            alt="Tao CV online an tuong"
                            ...
                            <div className=" box-content col-md-5">
                                <div className="box-create-cv">
                                    ...
                                    <div className="box-image box-upload d-flex align-items-center justify-content-center">
                                        <img
                                            src="https://www.topcv.vn/v4/image/welcome/upload-cv.png?v=1.0.0"
                                            title="Sử dụng CV theo ngành nghề"
                                            alt="Su dung CV theo nganh nghe"
                                            className="img-responsive"
                                        />
                                    </div>
                                </div>
                    ...
                    <div className="list-job col-md" id="list-job">
                        ...
                        <div className="box-smart-list-location d-flex">
                            <div
                                ...
                                className={
                                    active === ""
                                        ? " active box-smart-item"
                                        : " box-smart-item"
                                }
                                onClick={() => handleJobarea("")}
                            >
                                Ngẫu Nhiên
                            </div>
                            <div
                            ...
                            <div
                                ...
                                onClick={() => handleJobarea("Hồ Chí Minh")}
                            >
                            ...
                            <div
                                ...
                                onClick={() => handleJobarea("Miền Bắc")}
                            >
                                Miền Bắc
                            </div>
                            <div
                                ...
                                onClick={() => handleJobarea("Miền Nam")}
                            >
                                Miền Nam
                            </div>
                        </div>
                                    ...
                                    >
                                        <div className="job-item">
                                            ...
                                            <div className="label-content d-flex align-items-center">
                                                <label className="label-item flex-fill salary">
                                                    <i className="icon fa-solid fa-coins"></i>
                                                    {job.salary}
                                                </label>
                                                <label className="label-item flex-fill form">
                                                    <i className="icon fa-solid fa-business-time"></i>
                                                    {job.form}
                                                </label>
                                                <label className="label-item flex-fill deadline">
                        ...
                        <Slider {...settings}>
                            <div>
                                <div className="d-flex justify-content-evenly mb-3">
                                    <div
                                        className="box-item d-flex align-items-center"
                                        onClick={() => popularJob("Marketing")}
                                    >
                                        <div className="icon d-flex justify-content-center align-items-center ">
                                            <i className="fa-solid fa-briefcase"></i>
                                        </div>
                                        <div className="text_ellipsis">
                                            <h4 className="name_category">
                                                Marketing
                                            </h4>
                                        </div>
                                    </div>
